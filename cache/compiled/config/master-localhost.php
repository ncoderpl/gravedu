...
return [
    ...
    'checksum' => '2c667dfb72ab73281fefaf63623dde69',
    'files' => [
        'user/config' => [
            'media' => [
            ...
            'plugins/count-views' => [
                'file' => 'user/config/plugins/count-views.yaml',
                'modified' => 1788501497
            ],
            'site' => [
        ...
        'user/plugins' => [
            ...
            'plugins/private-site' => [
                'file' => 'user/plugins/private-site/private-site.yaml',
                'modified' => 1788504101
            ]
        ],
        'user/themes' => [
            'themes/foundation' => [
                'file' => 'user/themes/foundation/foundation.yaml',
                'modified' => 1788501497
            ],
            'themes/knowledge-base' => [
                'file' => 'user/themes/knowledge-base/knowledge-base.yaml',
                'modified' => 1788501497
            ],
            ...
            'themes/vela' => [
                'file' => 'user/themes/vela/vela.yaml',
                'modified' => 1788501497
            ]
        ]
    ],
    'data' => [
        'themes' => [
            ...
            'vela' => [
                'enabled' => true,
                'title_in_menu' => '<div style=\'font-size: 30px\'>Vela<sub style=\'font-size: 15px;padding-top:7px;\'>v1.2.3</sub></div><span ></span>',
                'use_logo' => true,
                'logo_size' => 55,
                'size_dimension' => 0,
        ...
        'plugins' => [
            ...
            'api' => [
                ...
                'popularity' => [
                    ...
                    'salt' => '76c5c6f6fbc9082dabf4fbea42d2f34423a7ceca039b69abad81e1964006003a'
                ]
            ],
            'breadcrumbs' => [
                'enabled' => true,
...
node_modules'
        ...
        'versions' => [
            'core' => [
                'grav' => [
                    'version' => '2.0.24',
                    'schema' => '1.8.0_2026-08-13_0',
                    'history' => [
                        0 => [
                            'version' => '2.0.24',
                            'date' => '2026-09-04 06:32:26'
                        ]
                    ]
                ]
            ]
