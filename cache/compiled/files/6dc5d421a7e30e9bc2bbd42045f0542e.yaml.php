...
return [
    ...
    'filename' => '/home/kamil/Desktop/gravEdu/user/plugins/login/languages/fr.yaml',
    'modified' => 1788501497,
    'size' => 18108,
    'data' => [
        'PLUGIN_LOGIN' => [
            ...
            'BTN_MAGIC_LINK' => 'Connexion par lien',
            'BTN_MAGIC_SEND_LINK' => 'Envoyer le lien de connexion',
            ...
            'FORGOT_INSTRUCTIONS_SENT_VIA_EMAIL' => 'Si un compte existe, les instructions pour la réinitialisation de votre mot de passe ont été envoyées par e-mail',
            ...
            'MAGIC_LINK_SENT' => 'Si un compte existe, un lien de connexion a été envoyé par e-mail',
            'MAGIC_LINK_RATE_LIMITED' => 'Trop de tentatives. Veuillez patienter %s minutes avant de réessayer.',
            'MAGIC_LINK_EMAIL_NOT_CONFIGURED' => 'Impossible d’envoyer le lien de connexion. Ce site n’est pas configuré pour envoyer des e-mails.',
            'MAGIC_LINK_EMAIL_NOT_UNIQUE' => 'Plusieurs comptes ont été trouvés pour cet e-mail. La connexion par lien est temporairement indisponible. Veuillez contacter l’administrateur.',
            'MAGIC_LINK_INVALID' => 'Lien de connexion invalide, veuillez réessayer',
            'MAGIC_LINK_EXPIRED' => 'Le lien de connexion a expiré, veuillez en demander un nouveau',
            'MAGIC_PAGE_TITLE' => 'Connexion par lien e-mail',
            'MAGIC_PAGE_DESC' => 'Saisissez votre adresse e-mail pour recevoir un lien de connexion à usage unique.',
            'MAGIC_LOGIN_EMAIL_SUBJECT' => '%s Lien de connexion',
            'MAGIC_LOGIN_EMAIL_MESSAGE' => 'Utilisez le lien à usage unique ci-dessous pour vous connecter.',
            'MAGIC_LOGIN_EMAIL_BODY' => '<h1>Lien de connexion</h1><p>Bonjour,</p><p>Vous avez demandé un lien de connexion à usage unique pour <b>%1$s</b>.</p><p>%2$s</p><p><br/><a href="%3$s" class="btn-primary">Se connecter</a><br/><br/></p><p>Vous pouvez également copier l’URL suivante dans la barre d’adresse de votre navigateur :</p><p class="word-break"><a href="%3$s">%3$s</a></p><p><br/>Cordialement,<br/><br/>%4$s</p>',
            ...
            'ROUTE_MAGIC' => 'Chemin de demande du lien de connexion',
            'ROUTE_MAGIC_LOGIN' => 'Chemin de connexion par lien',
            ...
            'MAGIC_LINK_ENABLED' => 'Activer la connexion par lien magique',
            'MAGIC_LINK_ENABLED_HELP' => 'Permet aux utilisateurs de demander un lien de connexion à usage unique par e-mail',
            'MAGIC_LINK' => 'Lien magique',
            'MAGIC_LINK_TTL' => 'Durée de validité du lien magique',
            'MAGIC_LINK_TTL_HELP' => 'Durée de validité du lien de connexion, en minutes',
            'MAGIC_LINK_MAX_REQUESTS_COUNT' => 'Nombre maximal de demandes de lien magique',
            'MAGIC_LINK_MAX_REQUESTS_COUNT_HELP' => 'Protection contre les demandes excessives de lien magique (0 - illimité)',
            'MAGIC_LINK_MAX_REQUESTS_INTERVAL' => 'Intervalle des demandes de lien magique',
            'MAGIC_LINK_MAX_REQUESTS_INTERVAL_HELP' => 'Intervalle de temps pour le nombre maximal de demandes de lien magique',
            'MAGIC_LINK_REDIRECT_AFTER_REQUEST' => 'Chemin après la demande de lien magique',
            'MAGIC_LINK_REDIRECT_AFTER_REQUEST_HELP' => 'Chemin vers lequel rediriger après la demande d’un lien de connexion'
        ]
    ]
];
