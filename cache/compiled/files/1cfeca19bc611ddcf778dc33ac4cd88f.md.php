...
return [
    ...
    'filename' => '/home/kamil/Desktop/gravEdu/user/pages/03.SSO/01.SSO - Wstep/docs.md',
    'modified' => 1788504029,
    'size' => 23348,
    'data' => [
        'header' => [
        ...
        'frontmatter' => 'title: \'Wprowadzenie do sieciowych systemów operacyjnych i wirtualizacji\'
date: \'2026-09-03\'
taxonomy:
...
summary: \'Architektura systemów serwerowych, porównanie Windows Server i Linux, modele licencjonowania, rola wirtualizacji oraz procedury wdrożeniowe.\'
private: true ',
        'markdown' => 'Sieciowy system operacyjny (ang. *Network Operating System* – NOS) to wyspecjalizowany system zaprojektowany do jednoczesnej obsługi wielu żądań sieciowych, centralnego zarządzania tożsamością i uprawnieniami, koordynacji współdzielonych zasobów dyskowych oraz ciągłego świadczenia usług w architekturze klient-serwer.
