...
return [
    ...
    'filename' => '/home/kamil/Desktop/gravEdu/user/plugins/email/languages.yaml',
    'modified' => 1788501497,
    'size' => 16929,
    'data' => [
        'en' => [
        ...
        'es' => [
            'PLUGIN_EMAIL' => [
                ...
                'MAIL_ENGINE_DISABLED' => 'Deshabilitado',
                'MAIL_ENGINE_DESC' => 'NOTA: Si selecciona un motor proporcionado por otro plugin, debe configurar las opciones en ese plugin.',
                'CONTENT_TYPE' => 'Tipo de contenido',
                'CONTENT_TYPE_PLAIN_TEXT' => 'Texto plano',
                'CHARSET' => 'Juego de caracteres',
                'CHARSET_PLACEHOLDER' => 'Por defecto UTF-8',
                'EMAIL_FORM' => 'Dirección de remitente',
                'EMAIL_FORM_PLACEHOLDER' => 'Dirección de correo por defecto del remitente',
                'EMAIL_FROM_NAME' => 'Nombre del remitente',
                'EMAIL_FROM_NAME_PLACEHOLDER' => 'Nombre del remitente por defecto',
                'EMAIL_TO' => 'Dirección del destinatario',
                'EMAIL_TO_PLACEHOLDER' => 'Dirección de correo por defecto del destinatario',
                'EMAIL_TO_NAME' => 'Nombre del destinatario',
                'EMAIL_TO_NAME_PLACEHOLDER' => 'Nombre del destinatario por defecto',
                'EMAIL_CC' => 'Dirección CC',
                'EMAIL_CC_PLACEHOLDER' => 'Dirección CC de correo por defecto',
                'EMAIL_CC_NAME' => 'Nombre CC',
                'EMAIL_CC_NAME_PLACEHOLDER' => 'Nombre CC por defecto',
                'EMAIL_BCC' => 'Dirección BCC',
                'EMAIL_BCC_PLACEHOLDER' => 'Dirección BCC de correo por defecto',
                'EMAIL_REPLY_TO' => 'Dirección de respuesta',
                'EMAIL_REPLY_TO_PLACEHOLDER' => 'Dirección de correo por defecto para respuesta',
                'EMAIL_REPLY_TO_NAME' => 'Nombre de respuesta',
                'EMAIL_REPLY_TO_NAME_PLACEHOLDER' => 'Nombre de respuesta por defecto',
                'EMAIL_BODY' => 'Cuerpo',
                'EMAIL_BODY_PLACEHOLDER' => 'Por defecto tabla de todos los campos del formulario',
                'SMTP_SERVER' => 'Servidor SMTP',
                'SMTP_SERVER_PLACEHOLDER' => 'ej. smtp.google.com',
                'SMTP_PORT' => 'Puerto SMTP',
                'SMTP_PORT_PLACEHOLDER' => 'Por defecto 25 (texto plano) / 587 (encriptado)',
                'SMTP_ENCRYPTION' => 'Encriptación SMTP',
                'SMTP_ENCRYPTION_NONE' => 'Ninguno',
                'SMTP_LOGIN_NAME' => 'Nombre de usuario SMTP',
                'SMTP_PASSWORD' => 'Contraseña SMTP',
                'SMTP_AUTH_MODE' => 'Modo de autenticación SMTP',
                'PATH_TO_SENDMAIL' => 'Ruta al binario sendmail',
                'DEBUG' => 'Depuración',
                'EMAIL_NOT_CONFIGURED' => 'Correo no configurado',
                'PLEASE_CONFIGURE_A_TO_ADDRESS' => 'Por favor configura una dirección de destinatario en la configuración del Plugin de Email o en el formulario',
                'PLEASE_CONFIGURE_A_FROM_ADDRESS' => 'Por favor configura una dirección de remitente en la configuración del Plugin de Email o en el formulario',
                'TEST_EMAIL_BODY' => '<h1>Prueba de correo</h1><p>Este correo de prueba ha sido enviado según la siguiente configuración:</p>  <p><pre>%1$s</pre></p>',
                'EMAIL_DEFAULTS' => 'Valores por defecto del correo',
                'SMTP_CONFIGURATION' => 'Configuración SMTP/S',
                'SENDMAIL_CONFIGURATION' => 'Configuración de Sendmail',
                'ADVANCED' => 'Avanzado',
                'EMAIL_FOOTER' => 'GetGrav.org',
                'QUEUE_TITLE' => 'Cola de correos',
                'QUEUE_DESC' => 'Cuando habilita la cola de correos, los correos no se <i>envían inmediatamente</i>, sino que se envían a la cola, y luego el planificador de Grav <strong>vacía la cola</strong> y envía realmente los correos según la frecuencia configurada. Esto garantiza que Grav no espere a que se completen las conexiones de correo.',
                'QUEUE_ENABLED' => 'Habilitado',
                'QUEUE_FLUSH_FREQUENCY' => 'Frecuencia de vaciado',
                'QUEUE_FLUSH_FREQUENCY_HELP' => 'Usar formato \'cron\'',
                'QUEUE_FLUSH_MSG_LIMIT' => 'Mensajes por vaciado',
                'QUEUE_FLUSH_MSG_LIMIT_APPEND' => 'Mensajes',
                'QUEUE_FLUSH_TIME_LIMIT' => 'Límite de tiempo de vaciado',
                'QUEUE_FLUSH_TIME_LIMIT_APPEND' => 'Segundos',
                'EMAIL_FORMAT' => 'Utilice el formato `addr`: `email@direccion.org` o formato `name-addr`: `Su nombre <email@direccion.org>`. Separados por comas para múltiples direcciones'
            ]
        ],
        'fr' => [
            'PLUGIN_EMAIL' => [
