...
return [
    ...
    'timestamp' => 1788504262,
    'checksum' => '2b3e26cb460d84b6bd397f7d04e1a398',
    'files' => [
        ...
        'user/plugins' => [
            ...
            'plugins/private-site' => [
                'file' => 'user/plugins/private-site/blueprints.yaml',
                'modified' => 1788503530
            ]
        ],
        'user/themes' => [
            'themes/foundation' => [
                'file' => 'user/themes/foundation/blueprints.yaml',
                'modified' => 1788501497
            ],
            'themes/knowledge-base' => [
                'file' => 'user/themes/knowledge-base/blueprints.yaml',
                'modified' => 1788501497
            ],
            ...
            'themes/vela' => [
                'file' => 'user/themes/vela/blueprints.yaml',
                'modified' => 1788501497
            ]
        ]
    ],
...
',
            ...
            'system.images.progressive_jpeg' => [
                'type' => 'toggle',
                ...
                'name' => 'system.images.progressive_jpeg',
                'validation' => 'loose'
            ],
            ...
            'plugins.api.translation_overrides' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.api.translation_overrides',
                'validation' => 'loose'
            ],
            ...
            'plugins.api.section_login_captcha' => [
                'type' => 'section',
                'underline' => true,
                'name' => 'plugins.api.section_login_captcha',
                'validation' => 'loose'
            ],
            'plugins.api.login' => [
                'type' => '_parent',
                'name' => 'plugins.api.login',
                'form_field' => false
            ],
            'plugins.api.login.captcha' => [
                'type' => '_parent',
                'name' => 'plugins.api.login.captcha',
                'form_field' => false
            ],
            'plugins.api.login.captcha.enabled' => [
                'type' => 'toggle',
                'label' => 'Login Captcha',
                'highlight' => 0,
                'default' => 0,
                ...
                'name' => 'plugins.api.login.captcha.enabled',
                'validation' => 'loose'
            ],
            'plugins.api.login.captcha.provider' => [
                'type' => 'select',
                ...
                'name' => 'plugins.api.login.captcha.provider',
                'validation' => 'loose'
            ],
            'plugins.api.login.captcha.mode' => [
                'type' => 'select',
                'label' => 'Captcha Mode',
                'default' => 'invisible',
                'options' => [
                ...
                'name' => 'plugins.api.login.captcha.mode',
                'validation' => 'loose'
            ],
            'plugins.api.login.captcha.flows' => [
                'type' => '_parent',
                'name' => 'plugins.api.login.captcha.flows',
                'form_field' => false
            ],
            'plugins.api.login.captcha.flows.login' => [
                'type' => 'toggle',
                'label' => 'Guard Login',
                'highlight' => 1,
                'default' => 1,
                ...
                'name' => 'plugins.api.login.captcha.flows.login',
                'validation' => 'loose'
            ],
            'plugins.api.login.captcha.flows.forgot_password' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.api.login.captcha.flows.forgot_password',
                'validation' => 'loose'
            ],
            'plugins.api.login.captcha.flows.setup' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.api.login.captcha.flows.setup',
                'validation' => 'loose'
            ],
            'plugins.api.login.captcha.cap' => [
                'type' => '_parent',
                'name' => 'plugins.api.login.captcha.cap',
                'form_field' => false
            ],
            'plugins.api.login.captcha.cap.challenge_difficulty' => [
                'type' => 'text',
                ...
                'name' => 'plugins.api.login.captcha.cap.challenge_difficulty',
                'validation' => 'loose'
            ],
            'plugins.api.login.captcha.cap.challenge_count' => [
                'type' => 'text',
                ...
                'name' => 'plugins.api.login.captcha.cap.challenge_count',
                'validation' => 'loose'
            ],
            ...
            'plugins.api.popularity.exclude_non_browsers' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.api.popularity.exclude_non_browsers',
                'validation' => 'loose'
            ],
            'plugins.api.popularity.exclude_agents' => [
                'type' => 'array',
                'label' => 'Excluded User Agents',
                'value_only' => true,
                'name' => 'plugins.api.popularity.exclude_agents',
                'validation' => 'loose'
            ],
            ...
            'plugins.git-sync.sync.direction' => [
                'type' => 'select',
                'label' => 'PLUGIN_GIT_SYNC.SYNC_DIRECTION',
                'size' => 'medium',
                'default' => 'both',
                'options' => [
                    'pull' => 'PLUGIN_GIT_SYNC.SYNC_DIRECTION_PULL',
                    'both' => 'PLUGIN_GIT_SYNC.SYNC_DIRECTION_BOTH'
                ],
                'name' => 'plugins.git-sync.sync.direction',
                'validation' => 'strict'
            ],
            'plugins.git-sync.folders' => [
                'type' => 'select',
                'multiple' => true,
                'label' => 'PLUGIN_GIT_SYNC.FOLDERS',
                'classes' => 'fancy',
                'description' => 'PLUGIN_GIT_SYNC.FOLDERS_DESCRIPTION',
                'default' => [
                    0 => 'pages'
                ],
                'options' => [
            ...
            'plugins.git-sync.SyncNotice' => [
                'type' => 'hidden',
                'markdown' => true,
                'text' => 'PLUGIN_GIT_SYNC.SYNC_NOTICE',
                'name' => 'plugins.git-sync.SyncNotice',
                'validation' => 'strict'
            ],
            'plugins.git-sync.sync.on_save' => [
                'type' => 'toggle',
                'label' => 'PLUGIN_GIT_SYNC.SYNC_ON_SAVE',
                'default' => 1,
                'highlight' => 1,
                'options' => [
                    1 => 'PLUGIN_ADMIN.YES',
            ...
            'plugins.git-sync.sync.on_delete' => [
                'type' => 'toggle',
                'label' => 'PLUGIN_GIT_SYNC.SYNC_ON_DELETE',
                'default' => 1,
                'highlight' => 1,
                'options' => [
                    1 => 'PLUGIN_ADMIN.YES',
            ...
            'plugins.git-sync.sync.on_media' => [
                'type' => 'toggle',
                'label' => 'PLUGIN_GIT_SYNC.SYNC_ON_MEDIA',
                'default' => 1,
                'highlight' => 1,
                'options' => [
                    1 => 'PLUGIN_ADMIN.YES',
            ...
            'plugins.git-sync.sync.cron_enable' => [
                'type' => 'toggle',
                'label' => 'PLUGIN_GIT_SYNC.SYNC_CRON_ENABLE',
                'default' => 0,
                'highlight' => 1,
                'options' => [
                    1 => 'PLUGIN_ADMIN.YES',
            ...
            'plugins.git-sync.sync.cron_at' => [
                'type' => 'cron',
                'label' => 'PLUGIN_GIT_SYNC.SYNC_CRON_AT',
                'default' => '0 12,23 * * *',
            ...
            'plugins.git-sync.no_user' => [
                ...
                'description' => 'PLUGIN_GIT_SYNC.NO_USER_DESCRIPTION',
                'name' => 'plugins.git-sync.no_user',
                'validation' => 'strict'
            ],
            'plugins.git-sync.user' => [
                'type' => 'text',
                'label' => 'PLUGIN_GIT_SYNC.GIT_USER',
                'autocomplete' => 'off',
            ...
            'plugins.git-sync.password' => [
                'type' => 'enc-password',
                'label' => 'PLUGIN_GIT_SYNC.GIT_PASSWORD',
                'description' => 'PLUGIN_GIT_SYNC.GIT_PASSWORD_DESCRIPTION',
                'autocomplete' => 'off',
            ...
            'plugins.git-sync.webhook_enabled' => [
                'type' => 'toggle',
                'label' => 'PLUGIN_GIT_SYNC.WEBHOOK_ENABLED',
                'highlight' => 1,
                'default' => 0,
                'options' => [
                    1 => 'PLUGIN_ADMIN.ENABLED',
                ...
                'description' => 'PLUGIN_GIT_SYNC.WEBHOOK_ENABLED_DESCRIPTION',
                'name' => 'plugins.git-sync.webhook_enabled',
                'validation' => 'strict'
            ],
            'plugins.git-sync.webhook_secret' => [
                'type' => 'text',
                'label' => 'PLUGIN_GIT_SYNC.WEBHOOK_SECRET',
                'data-default@' => '\\Grav\\Plugin\\GitSyncPlugin::generateWebhookSecret',
                'description' => 'PLUGIN_GIT_SYNC.WEBHOOK_SECRET_DESCRIPTION',
                'markdown' => true,
            ...
            'plugins.git-sync.remote.name' => [
                'type' => 'text',
                'default' => 'origin',
                'label' => 'PLUGIN_GIT_SYNC.REMOTE_NAME',
            ...
            'plugins.git-sync.remote.branch' => [
                'type' => 'text',
                'default' => 'main',
                'label' => 'PLUGIN_GIT_SYNC.REMOTE_BRANCH',
            ...
            'plugins.git-sync.git.author' => [
                'type' => 'select',
                'default' => 'gituser',
                'label' => 'PLUGIN_GIT_SYNC.GIT_AUTHOR',
                'options' => [
                    'gituser' => 'PLUGIN_GIT_SYNC.GIT_AUTHOR_GITUSER',
                    'gitsync' => 'PLUGIN_GIT_SYNC.GIT_AUTHOR_GITSYNC',
                    'gravuser' => 'PLUGIN_GIT_SYNC.GIT_AUTHOR_GRAVUSER',
                    'gravfull' => 'PLUGIN_GIT_SYNC.GIT_AUTHOR_GRAVFULL'
                ],
            ...
            'plugins.git-sync.git.message' => [
                ...
                'label' => 'PLUGIN_GIT_SYNC.GIT_MESSAGE',
            ...
            'plugins.git-sync.git.name' => [
                'type' => 'text',
                'default' => 'GitSync',
                'label' => 'PLUGIN_GIT_SYNC.GIT_NAME',
            ...
            'plugins.git-sync.git.email' => [
                ...
                'label' => 'PLUGIN_GIT_SYNC.GIT_EMAIL',
            ...
            'plugins.git-sync.git.bin' => [
                'type' => 'text',
                'default' => 'git',
                'label' => 'PLUGIN_GIT_SYNC.GIT_BINARY',
                'name' => 'plugins.git-sync.git.bin',
                'validation' => 'strict'
            ],
            'plugins.git-sync.git.ignore' => [
                'type' => 'textarea',
                'label' => 'PLUGIN_GIT_SYNC.GIT_IGNORE',
                'rows' => 6,
            ...
            'plugins.git-sync.git.private_key' => [
                'type' => 'text',
                'label' => 'PLUGIN_GIT_SYNC.PRIVATE_SSH_KEY',
                'markdown' => true,
                'description' => 'PLUGIN_GIT_SYNC.PRIVATE_SSH_KEY_DESCRIPTION',
            ...
            'plugins.login.max_twofa_count' => [
                'type' => 'number',
                'size' => 'x-small',
                'label' => 'PLUGIN_LOGIN.MAX_2FA_COUNT',
                'append' => 'PLUGIN_LOGIN.ATTEMPTS',
                'validate' => [
                    'type' => 'number',
                    'min' => 0
                ],
                'name' => 'plugins.login.max_twofa_count',
                'validation' => 'loose'
            ],
            'plugins.login.max_twofa_interval' => [
                'type' => 'number',
                'size' => 'x-small',
                'label' => 'PLUGIN_LOGIN.MAX_2FA_INTERVAL',
                'append' => 'PLUGIN_LOGIN.MINUTES',
                'validate' => [
                    'type' => 'number',
                    'min' => 1
                ],
                'name' => 'plugins.login.max_twofa_interval',
                'validation' => 'loose'
            ],
            ...
            'plugins.prism-highlight.section_plugins' => [
                'type' => 'section',
                'underline' => true,
                'name' => 'plugins.prism-highlight.section_plugins',
                'validation' => 'strict'
            ],
            ...
            'plugins.prism-highlight.section_advanced' => [
                'type' => 'section',
                'underline' => true,
                'name' => 'plugins.prism-highlight.section_advanced',
                'validation' => 'strict'
            ],
            'plugins.problems' => [
                'type' => '_root',
            ...
            'plugins.readingtime.include_image_views' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.readingtime.include_image_views',
                'validation' => 'strict'
            ],
            'plugins.readingtime.seconds_per_image' => [
                'type' => 'text',
                ...
                'name' => 'plugins.readingtime.seconds_per_image',
                'validation' => 'strict'
            ],
            'plugins.relatedpages' => [
                'type' => '_root',
            ...
            'plugins.private-site.enabled' => [
                ...
                'name' => 'plugins.private-site.enabled',
                'validation' => 'strict'
            ],
            'plugins.private-site.private_site' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.private-site.private_site',
                'validation' => 'strict'
            ],
            'themes.foundation' => [
                'type' => '_root',
            ...
            'themes.learn2-git-sync.gitsyncoptions' => [
                'type' => 'section',
                'underline' => true,
                'name' => 'themes.learn2-git-sync.gitsyncoptions',
                'validation' => 'loose'
            ],
            ...
            'themes.learn2-git-sync.siteandpageoptions' => [
                'type' => 'section',
                'underline' => true,
                'name' => 'themes.learn2-git-sync.siteandpageoptions',
                'validation' => 'loose'
            ],
            ...
            'themes.vela.title_in_menu' => [
                'type' => 'text',
                'label' => 'Title in menu',
                'name' => 'themes.vela.title_in_menu',
                'validation' => 'loose'
            ],
            'themes.vela.use_logo' => [
                'label' => 'Use logo',
                'type' => 'toggle',
                'default' => 1,
                'options' => [
                ...
                'name' => 'themes.vela.use_logo',
                'validation' => 'loose'
            ],
            'themes.vela.custom_logo' => [
                'type' => 'file',
                ...
                'name' => 'themes.vela.custom_logo',
                'validation' => 'loose'
            ],
            'themes.vela.spacer' => [
                'type' => 'spacer',
                'text' => '',
                'name' => 'themes.vela.spacer',
                'validation' => 'loose'
            ],
            'themes.vela.column1' => [
                'type' => 'column',
                'name' => 'themes.vela.column1',
                'validation' => 'loose'
            ],
            'themes.vela.logo_size' => [
                'type' => 'number',
                'label' => 'Logo size in pixels',
                'name' => 'themes.vela.logo_size',
                'validation' => 'loose'
            ],
            'themes.vela.column2' => [
                'type' => 'column',
                'name' => 'themes.vela.column2',
                'validation' => 'loose'
            ],
            'themes.vela.size_dimension' => [
                ...
                'name' => 'themes.vela.size_dimension',
                'validation' => 'loose'
            ],
            'themes.vela.column3' => [
                'type' => 'column',
                'name' => 'themes.vela.column3',
                'validation' => 'loose'
            ],
            'themes.vela.columns' => [
                'type' => 'columns',
                'name' => 'themes.vela.columns',
                'validation' => 'loose'
            ],
            'themes.vela.hamburger_animation' => [
                'type' => 'text',
                'label' => 'Specify the hamburger animation. <a href="https://jonsuh.com/hamburgers/">Reference</a>',
                'name' => 'themes.vela.hamburger_animation',
                'validation' => 'loose'
            ],
            'themes.vela.sec1' => [
                'type' => 'section',
                'underline' => true,
                'name' => 'themes.vela.sec1',
                'validation' => 'loose'
            ],
            'themes.vela.notice' => [
                'type' => '_parent',
                'name' => 'themes.vela.notice',
                'form_field' => false
            ],
            'themes.vela.notice.yellow' => [
                'type' => 'text',
                'label' => 'Yellow markown notice text',
                'name' => 'themes.vela.notice.yellow',
                'validation' => 'loose'
            ],
            'themes.vela.notice.red' => [
                'type' => 'text',
                'label' => 'Red markown notice text',
                'name' => 'themes.vela.notice.red',
                'validation' => 'loose'
            ],
            'themes.vela.notice.blue' => [
                'type' => 'text',
                'label' => 'Blue markown notice text',
                'name' => 'themes.vela.notice.blue',
                'validation' => 'loose'
            ],
            'themes.vela.notice.green' => [
                'type' => 'text',
                'label' => 'Green markown notice text',
                'name' => 'themes.vela.notice.green',
                'validation' => 'loose'
            ],
            'themes.vela.sec2' => [
                'type' => 'section',
                ...
                'underline' => true,
                'name' => 'themes.vela.sec2',
                'validation' => 'loose'
            ],
            'themes.vela.desktop_mode' => [
                'type' => 'toggle',
                'label' => 'Desktop Mode.',
                'highlight' => 1,
                'default' => 0,
                ...
                'name' => 'themes.vela.desktop_mode',
                'validation' => 'loose'
            ],
            'themes.vela.desktop_min_width' => [
                'type' => 'number',
                'label' => 'Desktop min width (pixels)',
                'default' => 1200,
                'name' => 'themes.vela.desktop_min_width',
                'validation' => 'loose'
            ],
            'themes.vela.parents_routable' => [
                'type' => 'toggle',
                ...
                'name' => 'themes.vela.parents_routable',
                'validation' => 'loose'
            ],
            'themes.vela.sec3' => [
                'type' => 'section',
        ...
        'nested' => [
            ...
            'system' => [
                ...
                'images' => [
                    ...
                    'progressive_jpeg' => 'system.images.progressive_jpeg',
            ...
            'plugins' => [
                ...
                'api' => [
                    ...
                    'translation_overrides' => 'plugins.api.translation_overrides',
                    'allow_draft_preview' => 'plugins.api.allow_draft_preview',
                    'section_login_captcha' => 'plugins.api.section_login_captcha',
                    'login' => [
                        'captcha' => [
                            'enabled' => 'plugins.api.login.captcha.enabled',
                            'provider' => 'plugins.api.login.captcha.provider',
                            'mode' => 'plugins.api.login.captcha.mode',
                            'flows' => [
                                'login' => 'plugins.api.login.captcha.flows.login',
                                'forgot_password' => 'plugins.api.login.captcha.flows.forgot_password',
                                'setup' => 'plugins.api.login.captcha.flows.setup'
                            ],
                            'cap' => [
                                'challenge_difficulty' => 'plugins.api.login.captcha.cap.challenge_difficulty',
                                'challenge_count' => 'plugins.api.login.captcha.cap.challenge_count'
                            ]
                        ]
                    ],
                    ...
                    'popularity' => [
                        ...
                        'exclude_non_browsers' => 'plugins.api.popularity.exclude_non_browsers',
                        'exclude_agents' => 'plugins.api.popularity.exclude_agents'
                    ],
                ...
                'git-sync' => [
                    ...
                    'sync' => [
                        'direction' => 'plugins.git-sync.sync.direction',
                ...
                'login' => [
                    ...
                    'max_twofa_count' => 'plugins.login.max_twofa_count',
                    'max_twofa_interval' => 'plugins.login.max_twofa_interval',
                ...
                'prism-highlight' => [
                    ...
                    'section_plugins' => 'plugins.prism-highlight.section_plugins',
                    'plugins' => [
                    ...
                    'section_advanced' => 'plugins.prism-highlight.section_advanced',
                    'custom' => [
                ...
                'readingtime' => [
                    ...
                    'include_image_views' => 'plugins.readingtime.include_image_views',
                    'seconds_per_image' => 'plugins.readingtime.seconds_per_image'
                ],
                'relatedpages' => [
                ...
                'private-site' => [
                    'enabled' => 'plugins.private-site.enabled',
                    'private_site' => 'plugins.private-site.private_site'
                ]
            ],
            'themes' => [
                'foundation' => 'themes.foundation',
                'knowledge-base' => 'themes.knowledge-base',
                'learn2-git-sync' => [
                    'gitsyncoptions' => 'themes.learn2-git-sync.gitsyncoptions',
                    'github' => [
                    ...
                    'siteandpageoptions' => 'themes.learn2-git-sync.siteandpageoptions',
                ...
                'vela' => [
                    'sec1' => 'themes.vela.sec1',
                    'title_in_menu' => 'themes.vela.title_in_menu',
                    'use_logo' => 'themes.vela.use_logo',
                    'custom_logo' => 'themes.vela.custom_logo',
                    'columns' => 'themes.vela.columns',
                    'column1' => 'themes.vela.column1',
                    'spacer' => 'themes.vela.spacer',
                    'column2' => 'themes.vela.column2',
                    'logo_size' => 'themes.vela.logo_size',
                    'column3' => 'themes.vela.column3',
                    'size_dimension' => 'themes.vela.size_dimension',
                    'hamburger_animation' => 'themes.vela.hamburger_animation',
                    'sec2' => 'themes.vela.sec2',
                    'notice' => [
                        'yellow' => 'themes.vela.notice.yellow',
                        'red' => 'themes.vela.notice.red',
                        'blue' => 'themes.vela.notice.blue',
                        'green' => 'themes.vela.notice.green'
                    ],
                    'sec3' => 'themes.vela.sec3',
                    'desktop_mode' => 'themes.vela.desktop_mode',
                    'desktop_min_width' => 'themes.vela.desktop_min_width',
                    'parents_routable' => 'themes.vela.parents_routable'
                ]
            ]
        ],
        'dynamic' => [
